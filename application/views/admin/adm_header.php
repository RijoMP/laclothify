...
<head>
  ...
  <script src="<?php echo base_url();?>assets/admin/js/dataTables.bootstrap4.js"></script>
  ...
  <div class="container-scroller">
        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item nav-profile dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="profileDropdown">
              ...
              <a class="dropdown-item" href='<?php echo base_url();?>aneet/logout'>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url();?>aneet/dashboard">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url();?>aneet/stock">
              <i class="mdi mdi-view-headline menu-icon"></i>
              <span class="menu-title">Stock</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url();?>aneet/products">
              <i class="mdi mdi-chart-pie menu-icon"></i>
              <span class="menu-title">Products</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url();?>aneet/categories">
              <i class="mdi mdi-grid-large menu-icon"></i>
              <span class="menu-title">Category</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url();?>aneet/sitesettings">
